...
if __name__ == "__main__":
    ...
    if '?' in args or 'help' in args:
        ...
        print()
        print('Options:')
        print('-trp, --trpos: Defines the file from which positive training data should be read. Input as a .csv file with extension. Defaults to "data/X_train_pos processed.csv".')
