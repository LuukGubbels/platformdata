...
dfens = pd.DataFrame(columns = ["Ensemble", "TP","Pos. Est.","Bias","Pos. Est. P","BiasP","Acc", "Prec","Rec","F1","AUROC","BA","Phi"])
dfcal = copy(dfens)
...
avg_bias, avg_biasP, avg_acc, avg_prec, avg_rec, avg_f1, avg_auroc, avg_ba, avg_phi = np.zeros(9)
avg_bias_cal, avg_biasP_cal, avg_acc_cal, avg_prec_cal, avg_rec_cal, avg_f1_cal, avg_auroc_cal, avg_ba_cal, avg_phi_cal = np.zeros(9)
for i in tqdm(range(iters), leave=False):
    ...
    avg_phi = avg_phi + float(dfens['Phi'][i*(1+size)])
    ...
    avg_phi_cal += float(dfcal['Phi'][i*(1+size)])
...
newrow = ['Ensemble Average','-','-',avg_bias,'-',avg_biasP,avg_acc, avg_prec, avg_rec, avg_f1, avg_auroc, avg_ba, avg_phi]
dfens.loc[len(dfens)] = newrow
...
newrow = ['Ensemble Average','-','-',avg_bias_cal,'-',avg_biasP_cal,avg_acc_cal, avg_prec_cal, avg_rec_cal, avg_f1_cal, avg_auroc_cal, avg_ba_cal, avg_phi_cal]
dfcal.loc[len(dfcal)] = newrow
...
newrow = ['Individual Average','-','-',avg_bias,'-',avg_biasP,avg_acc, avg_prec, avg_rec, avg_f1, avg_auroc, avg_ba, avg_phi]
dfens.loc[len(dfens)] = newrow
...
newrow = ['Individual Average','-','-',avg_bias,'-',avg_biasP_cal,avg_acc_cal, avg_prec_cal, avg_rec_cal, avg_f1_cal, avg_auroc_cal, avg_ba_cal, avg_phi_cal]
dfcal.loc[len(dfcal)] = newrow
